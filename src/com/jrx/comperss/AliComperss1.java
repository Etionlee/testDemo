...
public class AliComperss1
{
    static String firstName = "赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻柏水窦章云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞任袁柳酆鲍史唐费廉岑薛雷贺倪汤滕殷罗毕郝邬安常乐于时傅皮卞齐康伍余元卜顾孟平黄和穆萧尹姚邵湛汪祁毛禹狄米贝明臧计伏成戴谈宋茅庞熊纪舒屈项祝董梁杜阮蓝闵席季麻强贾路娄危江童颜郭梅盛林刁钟徐邱骆高夏蔡田樊胡凌霍虞万支柯咎管卢莫经房裘缪干解应宗宣丁贲邓郁单杭洪包诸左石崔吉钮龚程嵇邢滑裴陆荣翁荀羊於惠甄魏加封芮羿储靳汲邴糜松井段富巫乌焦巴弓牧隗山谷车侯宓蓬全郗班仰秋仲伊宫宁仇栾暴甘钭厉戎祖武符刘姜詹束龙叶幸司韶郜黎蓟薄印宿白怀蒲台从鄂索咸籍赖卓蔺屠蒙池乔阴郁胥能苍双闻莘党翟谭贡劳逄姬申扶堵冉宰郦雍却璩桑桂濮牛寿通边扈燕冀郏浦尚农温别庄晏柴瞿阎充慕连茹习宦艾鱼容向古易慎戈廖庚终暨居衡步都耿满弘匡国文寇广禄阙东殴殳沃利蔚越夔隆师巩厍聂晁勾敖融冷訾辛阚那简饶空曾毋沙乜养鞠须丰巢关蒯相查后江红游竺权逯盖益桓公万俟司马上官欧阳夏侯诸葛闻人东方赫连皇甫尉迟公羊澹台公冶宗政濮阳淳于仲孙太叔申屠公孙乐正轩辕令狐钟离闾丘长孙慕容鲜于宇文司徒司空亓官司寇仉督子车颛孙端木巫马公西漆雕乐正壤驷公良拓拔夹谷宰父谷粱晋楚阎法汝鄢涂钦段干百里东郭南门呼延归海羊舌微生岳帅缑亢况后有琴梁丘左丘东门西门商牟佘佴伯赏南宫墨哈谯笪年爱阳佟第五言福百家姓续";
    static String girl = "秀娟英华慧巧美娜静淑惠珠翠雅芝玉萍红娥玲芬芳燕彩春菊兰凤洁梅琳素云莲真环雪荣爱妹霞香月莺媛艳瑞凡佳嘉琼勤珍贞莉桂娣叶璧璐娅琦晶妍茜秋珊莎锦黛青倩婷姣婉娴瑾颖露瑶怡婵雁蓓纨仪荷丹蓉眉君琴蕊薇菁梦岚苑婕馨瑗琰韵融园艺咏卿聪澜纯毓悦昭冰爽琬茗羽希宁欣飘育滢馥筠柔竹霭凝晓欢霄枫芸菲寒伊亚宜可姬舒影荔枝思丽 ";
    ...
    static String name_sex = "";
    public Map<String, Integer> areaCode = new HashMap();
    ...
    public void justDoIt() {
        try {
            AliComperss1 aliComperss = new AliComperss1();
            String result = aliComperss.httpPost("http://66.56.96.18:9553/api/ant/jiebei/promote", this.getXmlInfo());
    ...
    public String httpPost(String url, String xmlContent) {
        String result = "";
    ...
    public String getXmlInfo() {
        ...
        sb.append("<appId>ALIPAY</appId>");
        sb.append("<function>ant.jiebei.institution.cooperation.promote.apply</function>");
        sb.append("<reqTime>20181211145511</reqTime>");
        sb.append("<reqTimeZone>UTC+8</reqTimeZone>");
        sb.append("<reqMsgId>d4dc6c1e2c1e4a62813e1988aecd3a7f</reqMsgId>");
        sb.append("<reserve/>");
    ...
    public String getApplyNo() {
        ...
        return "201812100001710" + random.nextInt(10) + random.nextInt(10) + random.nextInt(10) + "A";
    }
    ...
    private String getChineseName() {
        int index = this.getNum(0, firstName.length() - 1);
        String first = firstName.substring(index, index + 1);
        int sex = this.getNum(0, 1);
        String str = boy;
        ...
        index = this.getNum(0, length - 1);
        String second = str.substring(index, index + 1);
        int hasThird = this.getNum(0, 1);
        String third = "";
        if (hasThird == 1) {
            index = this.getNum(0, length - 1);
    ...
    public Map initAreaMap(Map areaCode) {
    ...
    public String generate() {
        this.initAreaMap(this.areaCode);
    ...
    public int randomAreaCode() {
        int index = (int)(Math.random() * (double)this.areaCode.size());
        Collection values = this.areaCode.values();
